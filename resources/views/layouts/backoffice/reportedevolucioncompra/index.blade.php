...
<div class="panel panel-danger" data-sortable-id="ui-widget-3">
    <div class="panel-heading ui-sortable-handle">
        <div class="btn-group btn-group-toggle pull-right">
            <a class="btn btn-dark btn-xs" href="{{ url('backoffice/reportedevolucioncompra') }}"><i class="fa fa-angle-left"></i> Ir Atras</a>
        </div>
        <h4 class="panel-title">Reporte de Devolución de Compras</h4>
    </div>
    <div class="panel-body">
      <form action="{{ url('backoffice/reportedevolucioncompra') }}" method="GET"> 
      ...
      <div class="table-responsive">
         @include('layouts.backoffice.reportedevolucioncompra.tabla')
         {{ $devolucioncompra->links('app.tablepagination', ['results' => $devolucioncompra]) }}
      </div>
    </div>
</div>
@endsection
...
<script>
    ...
    function reporte(tipo){
        window.location.href = '{{url('backoffice/reportedevolucioncompra')}}?'+
                                'tipo='+tipo+
                                '&codigo='+$('#codigo').val()+
    ...
    $("#idresponsable").select2({
        ajax: {
            url:"{{url('backoffice/reportedevolucioncompra/showlistarusuario')}}",
            dataType: 'json',
            delay: 250,
