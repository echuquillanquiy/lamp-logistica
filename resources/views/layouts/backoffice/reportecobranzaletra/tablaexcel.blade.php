<table style="width:100%">
    <thead>
        ...
        <tr>
            ...
            <th style="border: 1px solid black; font-weight: 900; background-color: #065f65; color: #ffffff;">Cod. Cobranza de Letra</th>
            ...
            <th style="border: 1px solid black; font-weight: 900; background-color: #065f65; color: #ffffff;">N° Letra</th>
    ...
    <tbody>
        <?php $total = 0; ?>
        @foreach($cobranzaletra as $value)
        ...
        <tr>
            ...
            <td style="border: 1px solid black;"><?php echo tipopago_detalle('cobranzaletra', $value->id)[ 'detalle' ] ?></td>
            <td style="border: 1px solid black;">{{ $value->idestado==2?$value->numeroletra:'---' }}</td>
