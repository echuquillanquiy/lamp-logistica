...
<form action="javascript:;" 
    ...
    <div class="modal-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <input type="text" value="{{ $usuario->nombre }}" id="nombrecomercial" class="form-control" disabled/>
            </div>
            <label class="col-sm-4 col-form-label">Razòn Social *</label>
            <div class="col-sm-8">
                <input type="text" value="{{ $usuario->apellidos }}" id="razonsocial" class="form-control" disabled/>
            </div>
        </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <input type="text" value="{{ $usuario->nombre }}" id="nombre" class="form-control" disabled/>
            </div>
            <label class="col-sm-4 col-form-label">Apellidos *</label>
            <div class="col-sm-8">
                <input type="text" value="{{ $usuario->apellidos }}" id="apellidos" class="form-control" disabled/>
            </div>
        </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <input type="text" value="{{ $usuario->numerotelefono }}" id="numerotelefono" class="form-control" disabled/>
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-4 col-form-label">Correo Electrónico</label>
            <div class="col-sm-8">
                <input type="text" value="{{ $usuario->email }}" id="email" class="form-control" disabled/>
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <input type="text" value="{{ $usuario->direccion }}" id="direccion" class="form-control" disabled/>
            </div>
        </div>
