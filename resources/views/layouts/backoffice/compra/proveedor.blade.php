...
<form action="javascript:;"  id="formproveedor"
          onsubmit="callback({
            route: 'backoffice/usuario',
            method: 'POST',
            idform: 'formproveedor',
            data:{
                view: 'registrar'
            }
        },
        function(resultado){
            removemodal('#mx-modal-carga-proveedor');     
            $('#idproveedor').html('<option value=\''+resultado.cliente.id+'\'>'+resultado.cliente.identificacion+' - '+resultado.cliente.apellidos+', '+resultado.cliente.nombre+'</option>'); 
        },this)"> 
...
<div class="modal-body">
    ...
    <div class="modal-footer">
          <a href="javascript:;" id="botonenviar" class="btn btn-success" onclick="$('#formproveedor').submit();">Guardar Cambios</a>
    </div>
</form>  
</div>            
<script>
