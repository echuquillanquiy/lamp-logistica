<div class="modal-content">
  <div id="carga-cotizacionventa">
    <div class="modal-header">
        <h4 class="modal-title">Devolucion de Producto</h4>
            ...
            <table class="table" id="tabla-ventacotizacion" style="margin-bottom: 5px;">
                <thead class="thead-dark">
                  <tr>
                    ...
                    <th width="50px">Cantidad a Devolver</th>
    ...
    <div class="modal-footer">
        <a href="javascript:;" class="btn btn-danger" onclick="$('#formcotizacionventa').submit();">Nota de Devolución</a>
        <a href="javascript:;" class="btn btn-success" onclick="$('#formcotizacionventa').submit();">Aumentar Saldo</a>
    </div>
  </div>
</div>