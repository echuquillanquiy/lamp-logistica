...
<form action="javascript:;"  onsubmit="callback({
    ...
    <div class="modal-header">
        <h4 class="modal-title">Registrar Saldo de Usuario</h4>
    ...
    <div class="modal-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <input type="number" id="saldoagregar"  class="form-control" value="0.00" disabled/>
            </div>
        </div>
        <div class="form-group row">
