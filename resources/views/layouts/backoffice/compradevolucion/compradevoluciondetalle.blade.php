om<div class="modal-content">
  <div id="carga-compradevolucion">
    <div class="modal-header">
        <h4 class="modal-title">Detalle de Compra de Devolución</h4>
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true" onclick="removemodal('#carga-compradevoluciondetalle')">×</button>
    </div>
