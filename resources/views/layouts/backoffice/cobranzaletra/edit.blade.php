...
<form action="javascript:;" 
    ...
    <div class="modal-header">
        <h4 class="modal-title">Editar Cobraza de Letra</h4>
    ...
    <div class="modal-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <input class="form-control" type="number" value="{{$cobranzaletra->monto}}" id="monto" placeholder="0.00" step="0.01" min="0"/>
            </div>
        </div>
...
$('#idventa').select2({
  ajax: {
    ...
    selectventa(e.currentTarget.value);
});
