        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input class="form-control" type="text" id="seriecorrelativo"/>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Fecha de Emisión *</label>
                    <div class="col-sm-9">
                        <input class="form-control" type="date" value="{{ Carbon\Carbon::now()->format('Y-m-d') }}" id="fechaemision"/>
                    </div>
                </div>
            </div>
        </div>
...
function agregarproducto(idproducto,codigoimpresion,nombreproducto,cantidad,precio,preciototal){
      ...
      var nuevaFila='<tr id="'+num+'" idproducto="'+idproducto+'" >';
          ...
          nuevaFila+='<td class="with-form-control"><input class="form-control" id="productUnidad'+num+'" type="number" value="0.00" onkeyup="calcularmonto()" onclick="calcularmonto()" step="0.01" min="0"></td>';
