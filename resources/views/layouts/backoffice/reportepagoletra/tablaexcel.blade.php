<table style="width:100%">
  <thead>
    ...
    <tr>
      ...
      <th style="border: 1px solid black; font-weight: 900; background-color: #065f65; color: #ffffff;">Cod. Pago de Letra</th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="border: 1px solid black;"><?php echo tipopago_detalle('pagoletra', $value->id)[ 'detalle' ] ?></td>
