...
<div class="panel panel-danger" data-sortable-id="ui-widget-3">
    <div class="panel-heading ui-sortable-handle">
        <div class="btn-group btn-group-toggle pull-right">
            <a href="javascript:;" class="btn btn-warning" onclick="modal({route:'usuario/create?view=registrar'})"><i class="fa fa-plus"></i> Registrar</a>
        </div>
                  ...
                  <td class="with-btn-group" nowrap>
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu pull-right">
                          <li><a href="javascript:;" onclick="modal({route:'usuario/{{ $value->id }}/edit?view=editar'})"><i class="fa fa-edit"></i> Editar</a></li>
                          @if($idpermiso==1 || $idpermiso==4)
<!--                               <li><a href="javascript:;" onclick="modal({route:'usuario/{{ $value->id }}/edit?view=permiso'})"><i class="fa fa-users"></i> Acceso</a></li> -->
                              <li><a href="javascript:;" onclick="modal({route:'usuario/{{ $value->id }}/edit?view=eliminar'})"><i class="fa fa-trash"></i> Eliminar</a></li>
                          @endif
                      </ul>
                    </div>
                  </td>
