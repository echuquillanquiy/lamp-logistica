    ...
    <div class="modal-body">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                ...
                <script>
                  ...
                  }).val({{$pagocredito->idbanco}}).trigger('change');
                </script>
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                 <input type="text" value="{{$pagocredito->deposito_numerocuenta}}" id="deposito_numerocuenta" class="form-control" disabled>
              </div>
            </div>
            <div class="form-group row">
              <label class="col-sm-4 col-form-label">Fecha de Deposito</label>
              <div class="col-sm-8">
                 <input type="date" value="{{$pagocredito->deposito_fecha}}" id="deposito_fecha" class="form-control" disabled>
              </div>
            </div>
            <div class="form-group row">
              <label class="col-sm-4 col-form-label">Hora de Deposito</label>
              <div class="col-sm-8">
                 <input type="time" value="{{$pagocredito->deposito_hora}}" id="deposito_hora" class="form-control" disabled>
              </div>
            </div>
            <div class="form-group row">
              <label class="col-sm-4 col-form-label">Número de Operación</label>
              <div class="col-sm-8">
                 <input type="number" value="{{$pagocredito->deposito_numerooperacion}}" id="deposito_numerooperacion" class="form-control" disabled>
              </div>
            </div>
        </div>
        <div id="cont-tipopagocheque" style="display:none;">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                 <input type="date" value="{{$pagocredito->cheque_emision}}" id="cheque_emision" class="form-control" disabled>
              </div>
            </div>
            <div class="form-group row">
              <label class="col-sm-4 col-form-label">Fecha de Vencimiento</label>
              <div class="col-sm-8">
                 <input type="date" value="{{$pagocredito->cheque_vencimiento}}" id="cheque_vencimiento" class="form-control" disabled>
              </div>
            </div>
            <div class="form-group row">
              <label class="col-sm-4 col-form-label">Número de Cheque</label>
              <div class="col-sm-8">
                 <input type="number" value="{{$pagocredito->cheque_numero}}" id="cheque_numero" class="form-control" disabled>
              </div>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <input class="form-control" type="number" value="{{$pagocredito->monto}}" id="monto" placeholder="0.00" step="0.01" min="0" disabled/>
            </div>
        </div>
    </div>
</div>
...
}).val({{$pagocredito->idtipopago}}).trigger('change');
</script>
