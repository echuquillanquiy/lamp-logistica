<div class="modal-content">
   <form action="javascript:;"
    ...
    <div class="modal-header">
        <h4 class="modal-title">Eliminar Nota de Devolución</h4>
            ...
            <div class="row">
                <div class="col-md-7"> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" value="{{ $notadevolucion->motivo }}" id="motivo" class="form-control" disabled>
                        </div>
                    </div> 
                </div>
                <div class="col-md-5"> 
...
function agregarproducto(codigo,nombre,motor,marca,modelo,preciounitario,unidad,cantidad){
