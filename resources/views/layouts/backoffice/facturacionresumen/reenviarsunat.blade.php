<div class="modal-content">
  <div id="carga-facturacionresumen">
    <div class="modal-header">
        <h4 class="modal-title">Reenviar Resumen Diario</h4>
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
    </div>
    <div class="modal-body"><br>
        <form action="javascript:;"  id="formfacturacionresumen" onsubmit="callback({
                                                                                          route: 'backoffice/facturacionresumen/{{  $facturacionresumen->id }}',
                                                                                          method: 'PUT',
    ...
    <div class="modal-footer">
        <a href="javascript:;" class="btn btn-success" onclick="$('#formfacturacionresumen').submit();">Reenviar a Sunat</a>
    </div> 
  </div>
</div>
<style>
