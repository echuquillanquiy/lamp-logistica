...
<form action="javascript:;" 
    ...
    <div class="modal-header">
        <h4 class="modal-title">Recepcionar Cierre de Caja</h4>
    ...
    <div class="modal-body">
        ...
        <div class="form-group row">
            <label class="col-sm-4 col-form-label">Monto de Cierre S/.</label>
            <div class="col-sm-8">
                <input class="form-control" type="number" value="{{ $aperturacierre->montocierresoles }}" id="montocierresoles" step="0.01" min="0" disabled/>
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-4 col-form-label">Monto de Cierre $</label>
            <div class="col-sm-8">
                <input class="form-control" type="number" value="{{ $aperturacierre->montocierredolares }}" id="montocierredolares" step="0.01" min="0" disabled/>
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            <label class="col-sm-4 col-form-label">Persona de Cierre</label>
            <div class="col-sm-8">
        ...
        <div class="alert alert-warning">
						<i class="fa fa-info-circle"></i> ¿Esta seguro de recepcionar?
				</div>
    </div>
